                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('petani.order.masuk') }}" class="text-primary text-small">Lihat
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('petani.order.diproses') }}" class="text-primary text-small">Lihat
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('petani.order.selesai') }}" class="text-primary text-small">Lihat
                                        Selengkapnya</a>
                                </div>
                            </div>
                        </div>
