                        ...
                        <div class="card-body">
                            <form action="{{ route('petani.update') }}" method="post">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old('petani_nama', $petani->petani_nama) }}" type="text"
                                        name="petani_nama" class="form-control @error('petani_nama') is-invalid @enderror">
                                    @error('petani_nama')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="petani_jk" data-placeholder="Pilih Jenis Kelamin" class="standardSelect"
                                        ...
                                        <option value="L"
                                            {{ old('petani_jk', $petani->petani_jk) == 'L' ? 'selected' : '' }}>Laki-Laki
                                        </option>
                                        <option value="P"
                                            {{ old('petani_jk', $petani->petani_jk) == 'P' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old('petani_tempatlahir', $petani->petani_tempatlahir) }}"
                                        type="text" name="petani_tempatlahir"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old('petani_tgllahir', $petani->petani_tgllahir) }}" type="date"
                                        name="petani_tgllahir"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old('petani_hp', $petani->petani_hp) }}" type="text"
                                        name="petani_hp" class="form-control @error('petani_hp') is-invalid @enderror">
                                    @error('petani_hp')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old('petani_alamat', $petani->petani_alamat) }}" type="text"
                                        name="petani_alamat"
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old('username', $petani->user->username) }}" type="email"
