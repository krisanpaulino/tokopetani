                    ...
                    <div class="card-body">
                        <form action="{{route('pembeli.update')}}" method="post">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input value="{{ old('nama_pembeli', $pembeli->nama_pembeli) }}" type="text" name="nama_pembeli" class="form-control @error('nama_pembeli') is-invalid @enderror">
                                @error('nama_pembeli')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input value="{{ old('no_telp', $pembeli->no_telp) }}" type="text" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror">
                                @error('no_telp')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group mb-4">
                                ...
                                <input value="{{ old('username', $pembeli->user->username) }}" type="email" name="username" class="form-control @error('username') is-invalid @enderror">
                                @error('username')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="alamat_provinsi" data-placeholder="Pilih Provinsi" class="standardSelect" tabindex="1">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="alamat_kota" data-placeholder="Pilih Kota" class="standardSelect" tabindex="1">
                                    <option value="" label="default"></option>
                                    @foreach ($kota as $r)
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input value="{{ old('alamat_desa', $pembeli->alamat_desa) }}" type="text" name="alamat_desa" class="form-control @error('alamat_desa') is-invalid @enderror">
                                @error('alamat_desa')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input value="{{ old('alamat_jalan', $pembeli->alamat_jalan) }}" type="text" name="alamat_jalan" class="form-control @error('alamat_jalan') is-invalid @enderror">
                                @error('alamat_jalan')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input value="{{ old('alamat_kodepos', $pembeli->alamat_kodepos) }}" type="text" name="alamat_kodepos" class="form-control @error('alamat_kodepos') is-invalid @enderror">
