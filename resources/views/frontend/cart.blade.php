                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('cart.delete') }}" method="post">
                                            @csrf
                                            <input type="hidden" name="detailpembelian_id"
                                                value="{{ $r->detailpembelian_id }}">
                        ...
                        <div class="bg-light rounded">
                            <div class="p-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <p class="mb-0">Rp{{ number_format($pembelian->total_bayar) }}</p>
                                </div>
                            </div>
                            <a class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4"
                                href="{{ route('checkout', $pembelian->pembelian_id) }}">Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
